...
- (void)viewDidLoad
{
    ...
    [rightCarousel numberOfItems:bound];
    [middleCarousel numberOfItems:bound];  
    [leftCarousel numberOfItems:bound];
...
- (IBAction)okButton:(id)sender 
{
    ...
    {
        bound=visibleItemField.text.intValue;
        [self viewDidLoad];
        if(segmentValue.selectedSegmentIndex==0)
        {
            [leftCarousel setUp];
